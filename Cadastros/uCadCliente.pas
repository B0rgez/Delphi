...
begin
  ...
  begin
   editClienteID.Text          := IntToStr(oCliente.codigo);
   editNome.Text               := oCliente.nome;
   editCEP.Text                := oCliente.cep;
   editEndereco.Text           := oCliente.endereco;
   editBairro.Text             := oCliente.bairro;
   editCidade.Text             := oCliente.cidade;
   editTelefone.Text           := oCliente.telefone;
   editEmail.Text              := oCliente.email;
   editDataNascimento.Date     := oCliente.dataNascimento;
  end
  else begin
   btnCancelar.Click;
   Abort;
...
procedure TfrmCadCliente.editDataNascimentoChange(Sender: TObject);
begin
  inherited;
